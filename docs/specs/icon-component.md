...
## Problem
See [`docs/discovery/icon-component.md`](../discovery/icon-component.md). In
...
- **Button spec update**: `docs/specs/button-enhancements.md`'s
...
- Predecessor relationship: [`button-enhancements.md`](button-enhancements.md).
