...
/**
 * Framework options for stories and tests
 */
...
/**
 * Programming language options for stories and tests
 */
...
/**
 * Grouped technology options for stories and tests.
 * Includes frontend frameworks, backend frameworks, databases, cloud platforms,
 * DevOps, programming languages, mobile dev, testing, CSS, build tools, and monitoring.
 */
export const groupedTechOptions: Option[] = [
	// Frontend Frameworks
	...
	{ id: 'elasticsearch', value: 'elasticsearch', label: 'Elasticsearch', group: 'NoSQL Databases' },
	...
	{ id: 'digitalocean', value: 'digitalocean', label: 'DigitalOcean', group: 'Cloud Platforms' },
	...
	{ id: 'javascript', value: 'javascript', label: 'JavaScript', group: 'Programming Languages' },
	{ id: 'typescript', value: 'typescript', label: 'TypeScript', group: 'Programming Languages' },
	...
	// Mobile Development
	{ id: 'react-native', value: 'react-native', label: 'React Native', group: 'Mobile Development' },
	...
	{ id: 'nativescript', value: 'nativescript', label: 'NativeScript', group: 'Mobile Development' },
	...
	{ id: 'prometheus', value: 'prometheus', label: 'Prometheus', group: 'Monitoring & Analytics' },
...
/**
 * Helper to extract unique group names from grouped options
 */
export const getGroupNames = (options: Option[]): string[] => {
	return [...new Set(options.map((opt) => opt.group).filter(Boolean))] as string[];
};

/**
 * Generates a large list of options for virtualized list stories
 */
export const generateLargeOptionList = (count: number): Option[] => {
