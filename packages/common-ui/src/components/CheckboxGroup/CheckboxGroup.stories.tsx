		...
		<div className='space-y-4'>
			...
			<div className='p-3 bg-gray-50 rounded border'>
				...
				<p className='text-xs text-gray-500 mt-1'>
					Selected count: {currentValues.length} / {options?.length ?? 0}
				</p>
			</div>
		</div>
	);
...
export const WithDisabledOption: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
...
export const WithDisabledGroup: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
			options={sampleOptions}
			name='disabled-group'
...
export const NoOptionsAvailable: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroup
			options={[]}
			name='empty-group'
...
export const CustomNoOptionsMessage: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroup
			options={[]}
...
export const HorizontalLayout: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
			options={sampleOptions}
...
export const MultipleSelections: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
			options={sampleOptions}
			name='multiple-group'
...
export const AllOptionsSelected: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
			options={sampleOptions}
...
export const WithCustomStyling: StoryObj<typeof CheckboxGroup> = {
	render: () => (
		<CheckboxGroupTemplate
			options={sampleOptions}
